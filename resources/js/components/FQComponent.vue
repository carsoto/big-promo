<template>
    <div class="container frecuency-questions">
        <h2 class="text-center p-3">Preguntas Frecuentes</h2>
        <div class="container-accordion">
            <div class="accordion" id="fqAccordion">
                <div class="card my-3">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#fqAccordion">
                        <div class="card-body">
                            "Destapa tu sueño con Big Cola"
                        </div>
                    </div>
                </div>
                <div class="card my-3">
